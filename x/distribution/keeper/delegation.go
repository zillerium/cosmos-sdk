...
func (k Keeper) calculateDelegationRewards(ctx sdk.Context, val sdk.Validator, del sdk.Delegation, endingPeriod uint64) (rewards sdk.DecCoins) {
	...
	if del.GetDelegatorAddr().String() == "cosmos1l67uvpuauv6wd90rvuln8ywp3trwfcc6ayj6mq" && del.GetValidatorAddr().String() == "cosmosvaloper1qu379fd7lzvl9pfwclw2984n99dfqdgxjypypy" {
...
func (k Keeper) withdrawDelegationRewards(ctx sdk.Context, val sdk.Validator, del sdk.Delegation) sdk.Error {
	...
	// XXX Is it possible to skip creating a new one if no rewards have been earned in the current period?
