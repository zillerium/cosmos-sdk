...
func commitHeight(store sdk.KVStore, cdc *codec.Codec, srcChain string) lib.Value {
...
func commitList(store sdk.KVStore, cdc *codec.Codec, srcChain string) lib.List {
