...
func egressQueue(store sdk.KVStore, cdc *codec.Codec, ty DatagramType, chainid string) lib.Linear {
...
func ingressSequence(store sdk.KVStore, cdc *codec.Codec, ty DatagramType, chainid string) lib.Value {
