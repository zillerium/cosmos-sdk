...
func outgoingQueue(store sdk.KVStore, cdc *codec.Codec, ty DatagramType, chainid string) lib.Linear {
...
func incomingSequence(store sdk.KVStore, cdc *codec.Codec, ty DatagramType, chainid string) lib.Value {
